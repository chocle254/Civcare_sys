  ...
  return (
    <div style={s.page}>
      ...
      <div style={s.chipsRow}>
        <button style={s.chipPrimary} onClick={() => navigate('/chat')}>
          <span style={s.chipIcon}>🧠</span>
          <span>AI Triage</span>
        </button>
        <button style={s.chipSecondary} onClick={() => navigate('/hospitals')}>
          <span style={s.chipIcon}>🏥</span>
          <span>Hospital</span>
        </button>
        <button style={s.chipSecondary} onClick={() => navigate('/consultation')}>
