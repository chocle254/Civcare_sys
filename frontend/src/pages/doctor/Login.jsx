          ...
          {mode === 'register' && (
            <>
              ...
              {[
                ...
                { label:'Specialisation',     name:'specialisation', placeholder:'e.g. General Practitioner' },
                { label:'Hospital Name *',    name:'hospital_name',  placeholder:'e.g. Kenyatta National Hospital' },
